Feature: Airport REST endpoint test
  ...
  Scenario: Creating an airport & check if it exists
    ...
    And Airport exists with name "London Airport", city name "London", iata "GKA", icao "AYGA", latitude "-6.081689834590001", longitude "145.391998291", altitude "5282", timeZone "10", dst "U", tz "Pacific/Port_Moresby", type "AIRPORT", source "OurAirports"
